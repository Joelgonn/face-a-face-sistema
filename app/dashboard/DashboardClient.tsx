...
export default function DashboardClient({ 
  ...
  // O estado inicial JÁ RECEBE OS DADOS DO SERVIDOR (Zero Loading!)
  ...
  // O Loading agora começa como FALSE, e só será usado quando for recarregar a lista após salvar algo
  ...
  // Função usada APENAS para atualizar a lista após adicionar/editar alguém
  ...
  const confirmCheckIn = async () => {
    ...
    // Otimista: Atualiza a tela antes do banco terminar
